...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0}, Lcom/umeng/newxp/net/b;-><init>()V
...
.method private a(Landroid/content/SharedPreferences$Editor;Lcom/umeng/common/ufp/net/f;)V
    .locals 4

    invoke-virtual {p2}, Lcom/umeng/common/ufp/net/f;->b()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p2}, Lcom/umeng/common/ufp/net/f;->d()Ljava/lang/String;
...
.method private a(Landroid/content/SharedPreferences;Landroid/content/SharedPreferences$Editor;I)V
    ...
    :cond_3
    new-instance v3, Lcom/umeng/newxp/net/m;

    invoke-direct {v3, v6}, Lcom/umeng/newxp/net/m;-><init>(Ljava/util/Map;)V

    invoke-super {p0, v3}, Lcom/umeng/newxp/net/b;->send(Lcom/umeng/common/ufp/net/f;)Lcom/umeng/common/ufp/net/ReportResponse$STATUS;
...
.method public static registerReportListener(Lcom/umeng/newxp/controller/XpListenersCenter$ReportListener;)V
    ...
    new-instance v0, Lcom/umeng/newxp/net/XpReportClient$1;

    invoke-direct {v0}, Lcom/umeng/newxp/net/XpReportClient$1;-><init>()V
...
.method public send(Lcom/umeng/common/ufp/net/f;)Lcom/umeng/common/ufp/net/ReportResponse$STATUS;
    ...
    check-cast v0, Lcom/umeng/newxp/net/m;

    iget-object v0, v0, Lcom/umeng/newxp/net/m;->d:Ljava/util/Map;

    invoke-interface {v1, v0}, Lcom/umeng/newxp/controller/XpListenersCenter$ReportListener;->onReportStart(Ljava/util/Map;)V

    :cond_0
    invoke-super {p0, p1}, Lcom/umeng/newxp/net/b;->send(Lcom/umeng/common/ufp/net/f;)Lcom/umeng/common/ufp/net/ReportResponse$STATUS;
    ...
    sget-object v3, Lcom/umeng/common/ufp/net/ReportResponse$STATUS;->SUCCESS:Lcom/umeng/common/ufp/net/ReportResponse$STATUS;
    ...
    invoke-interface {v1, v0}, Lcom/umeng/newxp/controller/XpListenersCenter$ReportListener;->onReportEnd(Lcom/umeng/common/ufp/net/ReportResponse$STATUS;)V
    ...
    :cond_2
    :try_start_1
    invoke-direct {p0, v2, p1}, Lcom/umeng/newxp/net/XpReportClient;->a(Landroid/content/SharedPreferences$Editor;Lcom/umeng/common/ufp/net/f;)V
    :try_end_1
